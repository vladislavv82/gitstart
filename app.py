...
app.config['MAIL_USERNAME'] = 'ak.vladislav52@yandex.ru' 	
app.config['MAIL_DEFAULT_SENDER'] = 'ak.vladislav52@yandex.ru' # тоже поменяй
app.config['MAIL_PASSWORD'] = 'akopian' or os.getenv('MAIL_PASS')
mail = Mail(app)
